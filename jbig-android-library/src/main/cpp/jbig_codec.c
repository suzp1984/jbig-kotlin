...
jbyteArray Java_io_github_suzp1984_jbig_1android_1library_JniJbigCodec_encodeNative(JNIEnv* env, jobject thiz, jobjectArray bitmap_array)
{
...
jobjectArray Java_io_github_suzp1984_jbig_1android_1library_JniJbigCodec_decodeNative(JNIEnv* env, jobject thiz, jbyteArray data)
{
